...
function showSelectedOperator(){
    ...
    for (var i=0; i<elements.length; i++){
        elements[i].style.backgroundColor  = "#e10bfd";
    }

    if (operator_value == "+"){
        document.getElementById("plusOp").style.backgroundColor  = "#e10bfd";
    }
    else if (operator_value == "-"){
        document.getElementById("subOp").style.backgroundColor  = "#e10bfd";
    }
    else if (operator_value == "*"){
        document.getElementById("multiOp").style.backgroundColor  = "#e10bfd";
    }
    else if (operator_value == "/"){
        document.getElementById("divOp").style.backgroundColor  = "#e10bfd";
    }
}
